...
CUDA_VISIBLE_DEVICES=7 python3 RSNA_FTLP.py --name efmp --stage train --model vit_base_patch16 --task RSNA --num_classes 2 \
    ...
    --output_dir "output/RSNA/100/" --data_volume '100' --num_steps 50000  --eval_batch_size 512 --img_size 224 \
    --learning_rate 5e-4 --warmup_steps 2000 --fp16 --fp16_opt_level O2 --train_batch_size 96