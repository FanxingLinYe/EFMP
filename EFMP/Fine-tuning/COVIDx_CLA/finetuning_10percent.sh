...
CUDA_VISIBLE_DEVICES=1 python COVIDx_FTLP.py --name ecamp --stage train --model vit_base_patch16 --task COVIDx --num_classes 3 \
    --pretrained_path '/mnt/data0/YXG/MedsARK/ORDER.pth' --dataset_path '/mnt/data0/YXG/COVIDX-7/' \
    --output_dir "output/COVIDx/10/" --data_volume '10' --num_steps 30000  --eval_batch_size 256 --img_size 224 \
