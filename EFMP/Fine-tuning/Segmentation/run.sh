...
# efmp
CUDA_VISIBLE_DEVICES=5 python train.py --name efmp --stage train --model vit_base_patch16 --task SIIM --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16.pth' --dataset_path '$PATH TO SIIM/' \
...
CUDA_VISIBLE_DEVICES=4 python train.py --name efmp --stage train --model vit_base_patch16 --task SIIM --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16.pth' --dataset_path '$PATH TO SIIM/' \
...
CUDA_VISIBLE_DEVICES=7 python train.py --name efmp --stage train --model vit_base_patch16 --task RSNA --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16.pth' --dataset_path '$PATH TO RSNA/' \
...
CUDA_VISIBLE_DEVICES=5 python train.py --name efmp --stage train --model vit_base_patch16 --task RSNA --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16.pth' --dataset_path '$PATH TO RSNA/' \
...
###### Finetune FFAIR efmp on RIGA

# FFAIR efmp
CUDA_VISIBLE_DEVICES=5 python train_RIGA.py --name efmp --stage train --model vit_base_patch16 --task RIGA --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16_fundus.pth' --dataset_path '$PATH TO RIGA' \
    --output_dir "output/RIGA/efmp/1/" --data_volume '1' --num_steps 500  --eval_batch_size 95 \
    --learning_rate 5e-4 --warmup_steps 15 --fp16 --fp16_opt_level O2 --train_batch_size 5 --weight_decay 0.05

CUDA_VISIBLE_DEVICES=5 python train_RIGA.py --name efmp --stage train --model vit_base_patch16 --task RIGA --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16_fundus.pth' --dataset_path '$PATH TO RIGA' \
    --output_dir "output/RIGA/efmp/10/" --data_volume '10' --num_steps 500  --eval_batch_size 95 \
    --learning_rate 5e-4 --warmup_steps 15 --fp16 --fp16_opt_level O2 --train_batch_size 56 --weight_decay 0.05

CUDA_VISIBLE_DEVICES=6 python train_RIGA.py --name efmp --stage train --model vit_base_patch16 --task RIGA --img_size 224 \
    --pretrained_path '$PATH TO efmp_ViT_Base_16_fundus.pth' --dataset_path '$PATH TO RIGA' \
    --output_dir "output/RIGA/efmp/100/" --data_volume '100' --num_steps 1000  --eval_batch_size 95 \
