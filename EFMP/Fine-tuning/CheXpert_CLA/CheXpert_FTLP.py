...
def valid(args, model, writer, test_loader, global_step):
    ...
    writer.add_scalar("valid10/loss", scalar_value=eval_losses.avg, global_step=global_step)
...
def main():
    ...
    parser.add_argument("--task", choices=["CheXpert"], default="CheXpert", help="Finetune task.")
